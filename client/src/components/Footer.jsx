    ...
    <footer className="bg-gray-800 text-white pt-10 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Empowering farmers with modern tools and technology. Connecting farmers directly to consumers.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/crop-recommendation" className="text-gray-400 hover:text-white">Crop Advisor</Link></li>
              <li><Link to="/disease-detection" className="text-gray-400 hover:text-white">Disease Detection</Link></li>
              <li><Link to="/weather" className="text-gray-400 hover:text-white">Weather</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Krishak Shayak. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
